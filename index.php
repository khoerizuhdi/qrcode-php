    ...
    <div style="width: 25rem;">
        <form action="index.php" method="post" name="form_qr" id="form_qr">
            <div class="card text-center">
                ...
                <div class="card-body">
                    <div class="mb-4" >
                    <input style="width: 21rem;" name="url" type="text" placeholder="Masukan Alamat URL" autocomplete="off">
                    </div>
                    <div class="mb-4" >
                    <input style="width: 21rem;" name="nama" type="text" placeholder="Masukan Nama File" autocomplete="off">
                    </div>
                    <div class="mb-1 ">
...
if (isset($_POST['url']))
{ 
include "/var/www/qrcode/AntiXSS.php";
$url = filter_var($_POST['url'], FILTER_SANITIZE_URL);
//$u=htmlspecialchars($_POST['url'], ENT_QUOTES, 'UTF-8');
$n=htmlspecialchars($_POST['nama'], ENT_QUOTES, 'UTF-8');
//$url = AntiXSS::setFilter($u, "whitelist", "string");
$nama = AntiXSS::setFilter($n, "whitelist", "string");
if (filter_var($url, FILTER_VALIDATE_URL)) {
 include "/var/www/qrcode/phpqrcode/qrlib.php"; 
  $tempdir = "/var/www/qrcode/temp/"; //Nama folder tempat menyimpan file qrcode
...
$img = file_get_contents('/var/www/qrcode/temp/qrwithlogo.png');
...
imagejpeg($thumb,'/var/www/qrcode/temp/'.$nama.'.png'); //save image as jpg
...
<div class="row justify-content-center mt-2">    
    <div style="width: 25rem;">
        <form action="download.php" method="post" name="form_qr" id="form_qr">          
                <div>
                    <input style="width: 21rem;" name="nama" type="hidden" value="<?php if(isset($nama)) { echo $nama;} ?>" pattern="[a-z][A-Z]{2,16}"">
                </div>
